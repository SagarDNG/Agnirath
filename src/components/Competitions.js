...
function Competitions() {
    ...
    return (
        <div id='competitions' className='d-flex align-items-center mb-5'>
            <div className='col-3'>
                <img data-aos="fade-right" src={Logo} alt="" className='competitionsLogo' />
            </div>
            <div data-aos="fade-down-left" className='col-lg-9 d-flex flex-wrap align-items-center justify-content-center'>
