...
function About() {
    ...
    return (
        <div id='about' className='row align-items-center mb-5 px-5'>
            <div data-aos="fade-right" className="col-3">
                <img src={Logo} alt="" className='aboutLogo' />
            </div>
            <div data-aos="fade-up" className="col-9 about text-center">We are Team Agnirath, a team of young brains, with a vision to contribute to
